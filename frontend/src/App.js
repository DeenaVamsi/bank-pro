    ...
    <div>
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/customerside" element={<CustomerDashboard />} />{" "}
          {/* Customer dashboard route */}
          {/* Account-related routes */}
          <Route path="/acc" element={<AccountList />} />{" "}
          {/* Account list route */}
          <Route path="/useracc" element={<UserAccounts />} />{" "}
          {/* User accounts route */}
          <Route path="/acctype" element={<AccountsByType />} />{" "}
          {/* Account by type route */}
          ...
          />{" "}
          {/* Recurring deposit route */}
          <Route path="/allfdrd" element={<AllDeposits />} />{" "}
          {/* All deposits route */}
          <Route path="/fdrd" element={<UserFDandRD />} />{" "}
          {/* User FD and RD route */}
          ...
          <Route
            path="/transaction"
            element={<FetchTransactionsByUser />}
          />{" "}
          {/* Transactions by user route */}
          {/* Loan-related routes */}
          <Route path="/loanform" element={<LoanForm />} />{" "}
          {/* Loan form route */}
          <Route path="/emi" element={<CalculateEMI />} />{" "}
          {/* Calculate EMI route */}
          <Route path="/loans" element={<AllLoans />} /> {/* All loans route */}
          <Route path="/adminchats" element={<AdminChatRoom />} />{" "}
          {/* admin chat room */}
          <Route path="/customerchats" element={<CustomerChatRoom />} />{" "}
          {/* customer chat room */}
        </Routes>
      </BrowserRouter>
    </div>
